            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="p-8 border rounded-xl hover:shadow-lg transition-all duration-300 bg-card group">
                <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-6 group-hover:bg-primary/20 transition-colors">
                  <IconWrapper icon={Home01Icon} size={24} className="text-primary" />
                </div>
              ...
              <div className="p-8 border rounded-xl hover:shadow-lg transition-all duration-300 bg-card group">
                <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-6 group-hover:bg-primary/20 transition-colors">
                  <IconWrapper icon={SearchIcon} size={24} className="text-primary" />
                </div>
              ...
              <div className="p-8 border rounded-xl hover:shadow-lg transition-all duration-300 bg-card group">
                <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-6 group-hover:bg-primary/20 transition-colors">
                  <IconWrapper icon={SettingsIcon} size={24} className="text-primary" />
                </div>
              ...
              <div className="p-8 border rounded-xl hover:shadow-lg transition-all duration-300 bg-card group">
                <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-6 group-hover:bg-primary/20 transition-colors">
                  <IconWrapper icon={StarIcon} size={24} className="text-primary" />
                </div>
              ...
              <div className="p-8 border rounded-xl hover:shadow-lg transition-all duration-300 bg-card group">
                <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-6 group-hover:bg-primary/20 transition-colors">
                  <IconWrapper icon={ShieldIcon} size={24} className="text-primary" />
                </div>
              ...
              <div className="p-8 border rounded-xl hover:shadow-lg transition-all duration-300 bg-card group">
                <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-6 group-hover:bg-primary/20 transition-colors">
                  <IconWrapper icon={CheckmarkCircleIcon} size={24} className="text-primary" />
                </div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  >
                    Explore <HeroArrowRightIcon className="h-4 w-4" />
                  </Link>
                </p>
              </div>
            </div>
