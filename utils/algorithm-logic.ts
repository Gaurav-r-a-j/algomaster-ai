...
export function generateBubbleSortSteps(initialArray: number[]): VisualizationStep[] {
...
export function generateSelectionSortSteps(initialArray: number[]): VisualizationStep[] {
  const array = [...initialArray];
  const steps: VisualizationStep[] = [];
  const n = array.length;
...
export function generateInsertionSortSteps(initialArray: number[]): VisualizationStep[] {
  const array = [...initialArray];
  const steps: VisualizationStep[] = [];
  const n = array.length;
...
export function generateMergeSortSteps(initialArray: number[]): VisualizationStep[] {
  const array = [...initialArray];
  const steps: VisualizationStep[] = [];
...
export function generateQuickSortSteps(initialArray: number[]): VisualizationStep[] {
  const array = [...initialArray];
  const steps: VisualizationStep[] = [];
...
export function generateQueueSteps(): VisualizationStep[] {
  const steps: VisualizationStep[] = [];
  const queue: number[] = [];
  const operations: (number | "DEQUEUE")[] = [10, 20, 30, "DEQUEUE", 40, "DEQUEUE"];
